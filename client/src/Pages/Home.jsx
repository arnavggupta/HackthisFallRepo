    ...
    <>
      ...
      <div className="bg-blue-700 min-h-screen">
          ...
          <div className=" bg-blue-700 h-screen w-screen relative flex flex-col justify-center">
            ...
            <div className="flex absolute justify-between">
              ...
              <div className="w-[40%] p-5 flex-col flex justify-center">
                <div className=" text-slate-200 tracking-wide text-4xl font-bold my-2">
                  Learn. Ask.. Solve...
                </div>
                <div className=" text-slate-400 text-lg leading-8 tracking-normal p-2">
                  A platform to ask your doubts , connect with like-minded
                  people and learn together
                </div>
                <div>
                  <button className=" bg-sky-500 p-3 rounded-lg m-3 tracking-wide font-semibold text-slate-800 font-sans text-lg">
                    SignUp now{" "}
                  </button>
                </div>
              </div>
        ...
        <div className="bg-blue-700 flex justify-end">
          <div className="text-white font-semibold py-6 px-12 text-5xl tracking-wide">
            About Us
          </div>
        </div>
        <div className="  bg-blue-700 flex justify-end">
          <div className="text-slate-300 text-lg leading-8 tracking-normal p-2 w-[40%] my-3">
            We are a community of developers, designers, artists, writers and
            thinkers who share their knowledge and skills through discussions,
            projects and showcases. Our aim is to create an environment where
            learners can help each other and learn together.
          </div>
        </div>
      </div>
    </>
